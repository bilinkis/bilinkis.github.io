...
INSERT INTO posts
VALUES (DEFAULT, 'Teg Clásico', 'Disfrutá de una apasionante acción bélica donde intervienen la lógica, la inteligencia y el azar.El juego tiene lugar en un planisferio dividido en 50 países. Cada jugador tiene un objetivo secreto a cumplir, para lo cual deberá, mediante diferentes estrategias, ampliar sus dominios, reordenar sus fuerzas, realizar pactos, emprender ataques y defenderse de los adversarios. El primer jugador en lograr su objetivo secreto, o conquistar 30 países (objetivo común), será el ganador.', '1.jpg', '1', DEFAULT, 8),
(DEFAULT, 'Monopoly', 'El emocionante juego de negociar propiedades. El objetivo de este juego es obtener grandes beneficios comprando y vendiendo propiedades, de tal forma que uno de los jugadores llegue a ser el más rico y por consiguiente el ganador.', '2.jpg', '5', DEFAULT, 5),
(DEFAULT, 'HDP', '¿Cuál es el más zarpado entre todos tus amigos? Un jugador (el HDP) lee una carta de pregunta (negra) y los demás responden con una de las cartas de su mano (blanca). La repuesta que le resulte más graciosa o zarpada al HD, gana un punto para el que la jugó. Un juego de humor absurdo, negro, sutil, disparatado.', '3.jpg', '1', DEFAULT, 3),
(DEFAULT, 'Catán', 'Pocos juegos reúnen tantas cualidades como Catan. Su mecánica innovadora, capaz de satisfacer hasta el paladar del jugador más exquisito en materia de juegos de mesa, lo ha hecho merecedor de los más importantes premios internacionales.', '4.jpg', '4', DEFAULT, 2),
...
(DEFAULT, 'Dables', 'Es un juego de cartas que se basa en la velocidad, observación y reflejos, en el que los jugadores compiten por encontrar el símbolo que coincide entre las cartas. ¡SÉ VELOZ, OBSERVÁ MUY BIEN Y TEN REFLEJOS PARA ENCONTRARLO ANTES QUE TUS ADVERSARIOS PARA GANAR!', '7.jpg', '4', DEFAULT, 1),
(DEFAULT, 'Virus', 'Una vez en plena guerra viral, hay que combatir la pandemia a base de ingenio, estrategia y mucha picardía. Todo vale para sobrevivir por encima de los demás: quien lo consiga habrá ganado al virus! Basta una partida en familia, o con los amigos, para encadenar batalla viral tras batalla viral, sin ninguna tregua', '8.jpg', '4', DEFAULT, 7),
